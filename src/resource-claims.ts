...
/**
 * Claim schema version 3 adds coordinated-write sharing. Schema 2 remains an
 * explicit legacy format whose claims never carry sharing semantics.
 */
export const RESOURCE_CLAIM_SCHEMA_VERSION = 3 as const;
export const LEGACY_RESOURCE_CLAIM_SCHEMA_VERSION = 2 as const;
