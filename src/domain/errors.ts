...
/**
 * Implementation-owned stable failures reachable from the public resource
 * claim lifecycle.  Contract discovery consumes this vocabulary rather than
 * maintaining an unrelated string inventory.
 */
export const RESOURCE_CLAIM_FAILURE_CODES = Object.freeze([
  "BACKEND_UNAVAILABLE",
  "INVALID_ARGUMENT",
  "MISSING_ARGUMENT",
  "INVALID_CLAIM",
...
function defaultExitCode(code: ErrorCode): number {
  if (
    ...
    code === "RUNTIME_PROFILE_REQUIREMENT_MISSING" ||
    code === "RUNTIME_PROVIDER_MISSING" ||
    code === "RUNTIME_MATERIALIZATION_MISSING"
  ) {
